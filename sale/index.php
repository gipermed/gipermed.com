...
?><? $APPLICATION->IncludeComponent("bitrix:sale.order.ajax", "bootstrap_v4_sale", Array(
	"ACTION_VARIABLE" => "soa-action",	// Название переменной, в которой передается действие
		...
		"ADDITIONAL_PICT_PROP_37" => "-",	// Дополнительная картинка [Каталог товаров 364FD872]
		"ADDITIONAL_PICT_PROP_38" => "-",	// Дополнительная картинка [Пакет предложений (Каталог товаров 364FD872)]
