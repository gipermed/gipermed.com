...
?>
    ...
    <form method="post" action="zakaz.php">
        <div class="blok registr">
            ...
            <div class="tel">Введите ваш номер телефона, чтобы мы могли сообщить вам о статусе заказа
        ...
        <div class="hidden dillev">
            <div class="blok">
                <h4>2 Доставка</h4>
                <p><input class="curradio" name="deliv" type="radio" value="18"> Доставка курьером</p>
                <p><input class="punktradio" name="deliv" type="radio" value="19"> Доставка до пункта выдачи заказов</p>
                <p class="samoviviz"><input name="deliv" type="radio" value="1"> Самовывоз</p>
                <p class=" curnazv hidden">Доставка осуществляется на следующий день после оплаты</p>

                <div class="blok curier hidden">
                    <h5>Получатель заказа</h5>
                    <p>Введите ФИО, чтобы курьер доставил товар именно вам</p>
                    <p><input type="text" name="fio" required placeholder="ФИО"></p>
                    <h5>Адрес доставки</h5>
                    <p><input name="delivadr" type="radio" value="3"> Новый адрес</p>
                    <p><input name="delivadr" type="radio" value="1" checked> Мои адреса</p>
                    <p>
