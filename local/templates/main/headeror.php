...
<script type="text/javascript">
  window.onload = function () {
	...
	jQuery("#user-regionr").text(ymaps.geolocation.region);
                ...
                <div class="head-col head-col-cabinet flex-row-item">
                    ...
                    <?php } else { ?>
                        <ul class="head-cabinet-links">
                            ...
                            <li>
								<a href="#modal-enter1" class="modal-open-btn">
                                    Вход
                                </a>
                            </li>
                        </ul>
            ...
            <div class="container">
                ...
                <ul class="header-catalog-menu-level-1">
                    ...
                    <li class="menu-item-has-children current-menu-item">
                        <a href="/catalog/tovary-dlya-roznitsy/meditsinskie-izdeliya/">
                            <i class="visible-tablet">
                    ...
                    <li>
                        <a href="/catalog/tovary-dlya-roznitsy/krasota-i-fitnes/">
                            <i class="visible-tablet">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="/catalog/tovary-dlya-roznitsy/lekarstva-i-bad/">
                            <i class="visible-tablet">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="/catalog/tovary-dlya-roznitsy/mat-i-ditya/">
                            <i class="visible-tablet">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="/catalog/tovary-dlya-roznitsy/zootovary/">
                            <i class="visible-tablet">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="hidden-tablet">
                        <a href="/catalog/tovary-dlya-roznitsy/">
