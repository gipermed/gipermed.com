	...
	BX.Sale.OrderAjaxComponent = {
		...
		createPaySystemItem: function(item)
		{
			...
			if (this.params.SHOW_PAY_SYSTEM_LIST_NAMES == 'Y')
			{
				...
				description = BX.create('DIV', {props: {className: 'bx-soa-pp-company-desc'}, html: item.DESCRIPTION});
			}
		...
		editTotalBlock: function()
		{
            ...
            $('.jsAllProductSum').html(this.createTotalUnit(false, priceHtml, params));
			...
			if (this.result.DELIVERY.length)
			{
                ...
                $('.JsDeliveryPrice').html(this.createTotalUnit(false, deliveryValue, params));
			}
			...
			if (this.options.showDiscountPrice)
			{
                ...
                $('.jsProductDiscount').html(this.createTotalUnit(false, total.DISCOUNT_PRICE_FORMATED, params));
                $('.jsAllDiscount').html(this.createTotalUnit(false, total.DISCOUNT_PRICE_FORMATED, params));
			}
			...
			{
                $('.jsAllSum').html(this.createTotalUnit(false, total.ORDER_TOTAL_PRICE_FORMATED, {total: true}));
