...
<div class="catalog-head">
    <div class="catalog-nav">
        ...
        if($_REQUEST['order'] == 'asc' || !$_REQUEST['order']){
            $order = 'desc';
        }else{
            $order = 'asc';
        }
    ...
    <div class="catalog-sort">
        ...
        <ul class="catalog-sort-links">
            <li>
                <a href="<?=$APPLICATION->GetCurPageParam('sort=price&order='.$order,array('sort','order'));?>" class="catalog-sort-link catalog-sort-link-arrow<?if($_REQUEST['sort'] == 'price' && $_REQUEST['order'] == 'asc' || $_REQUEST['sort'] == 'price' && !$_REQUEST['order'] == 'asc' || !$_REQUEST['sort']):?> active<?endif;?>">
                    <span>Цена</span>
            ...
            <li>
                <a href="<?=$APPLICATION->GetCurPageParam('sort=name&order='.$order,array('sort','order'));?>" class="catalog-sort-link catalog-sort-link-letter<?if($_REQUEST['sort'] == 'name' && $_REQUEST['order'] == 'asc'):?> active<?endif;?>">
                    <span>Название</span>
            ...
            <li>
                <a href="<?=$APPLICATION->GetCurPageParam('sort=rating&order='.$order,array('sort','order'));?>" class="catalog-sort-link catalog-sort-link-arrow<?if($_REQUEST['sort'] == 'rating' && $_REQUEST['order'] == 'asc'):?> active<?endif;?>">
                    <span>Рейтинг</span>
