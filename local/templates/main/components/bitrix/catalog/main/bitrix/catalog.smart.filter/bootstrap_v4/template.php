		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smart-filter-form">
			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="smart-filter-parameters-box bx-active">
							...
							<div class="catalog-filter-section catalog-filter-section-price">
                                    ...
                                    <div class="range-slider-wrapp">
                                        <div class="range-inputs">
                                            <label class="form-block">
                                                ...
                                                <input
                                                        class="input input-small range-input range-input-from"
                                                        type="number"
                                            ...
                                            <label class="form-block value">
                                                <span class="range-input-title">до</span>
                                                <input
                                                        class="input input-small range-input range-input-to"
                                                        type="number"
                                        ...
                                        <div class="range-slider ui-slider">
                                            <div class="smart-filter-slider-track" id="drag_track_<?=$key?>">
                                                    <div class="smart-filter-slider-ruler smart-filter-slider-ruler-none
                                                    p1"><span><?=$prices[0]?></span></div>
                                                    <div class="smart-filter-slider-ruler
                                                    p3"><span><?=$prices[2]?></span></div>
                                                    <div class="smart-filter-slider-ruler smart-filter-slider-ruler-none
                                                    p5"><span><?=$prices[4]?></span></div>
                                                <div class="smart-filter-slider-price-bar-vd ui-slider-range" style="left: 0;right: 0;"
                                                ...
                                                <div class="smart-filter-slider-range"
                                                     id="drag_tracker_<?=$key?>"  style="left: 0; right: 0;">
                                                    <a class="smart-filter-slider-handle left ui-slider-handle"
                                                       style="left:0;"
                                                       href="javascript:void(0)" id="left_slider_<?=$key?>"></a>
                                                    <a class="smart-filter-slider-handle right ui-slider-handle" style="right:0;"
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> smart-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="smart-filter-container-modef"></span>
			...
			<div class="row">
				<div class="col smart-filter-button-box">
					<div class="smart-filter-block">
						<div class="smart-filter-parameters-box-container">
                            <ul class="catalog-filter-btns">
                                <li>
                                    <input
                                            class="btn btn-full catalog-filter-submit"
                                            type="submit"
                                            id="set_filter"
                                            name="set_filter"
