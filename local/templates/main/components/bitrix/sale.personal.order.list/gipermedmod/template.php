		...
		foreach ($arResult['ORDERS'] as $key => $order): ?>
            <div class="order-item">
				<ul class="order-item-btns">
					<li  class="hidden-tablet" style="display:inline;  padding: 10px; font-size: 18px; font-weight: 600; color: #4365AF">
						Заказ <?= Loc::getMessage('SPOL_TPL_NUMBER_SIGN') . $order['ORDER']['ACCOUNT_NUMBER'] ?>
					</li>
					<? if ($order["ORDER"]["CAN_CANCEL"] === "Y"):?>
						<li class="hidden-tablet">
                            <div class="order-cancel">
                                <a href="<?= htmlspecialcharsbx('/sale/?ORDER_ID=').$order["ORDER"]["ID"] ?>"
                        ...
                        <div class="order-cart-head">
                            ...
                            <div class="order-cart-head-tr-wrapp">
                                <div class="order-tr order-tr-cart">
                                    <div class="order-td order-td-cart-title" style= "color: #4365AF">
                                        Подробнее о товарах
                                    </div>
