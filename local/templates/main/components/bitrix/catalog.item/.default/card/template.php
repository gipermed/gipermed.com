...
<div class="product-item">
    <div class="product-item__labels">
        ...
        <?if(current($item['OFFERS'][0]['PRICES'])['DISCOUNT_DIFF']>0):?>
            <div class="product-item__label label-discount"><?=Loc::getMessage('LABEL_SALE');?></div>
        <?endif;?>
    </div>
    <a href="javascript:void(0)" data-product="<?=$item['ID']?>" class="product-item__favorite js-add-favorites"><svg class="icon"><use xlink:href="#icon-like"></use></svg></a>
	<? if ($itemHasDetailUrl): ?>
