...
//console.log('onLoadPrices',data);
        ...
        setPrices: function(){
            ...
            $('#SDEK_cPrice2').html(IPOLSDEK_pvz.prices.courier[0]);
            $('#SDEK_cPrice3').html(IPOLSDEK_pvz.prices.courier[0]);
            $('#SDEK_cPricePicup').html(IPOLSDEK_pvz.prices.pickup[0]);
