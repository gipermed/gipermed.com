...
use Bitrix\Iblock\Elements\ElementmanufactersTable;
 ...
 *
 */
class ManufactersToPhoto implements Model,Arrayable,Jsonable
{
	...
	public function setAttributes(array $newValues): ManufactersToPhoto
	{
	...
	public static function findOne(array $filter = []): ?ManufactersToPhoto
	{
		/** @noinspection PhpUnhandledExceptionInspection */
		$userFields = ElementmanufactersTable::getRow([
			'filter' => $filter,
	...
	{
		/** @noinspection PhpUnhandledExceptionInspection */
		$users = collect(ElementmanufactersTable::getList([
			'filter' => $filter,
			'select' => array_merge(array_keys(self::getAttributesMap()),self::getPropertyMap()),
			'runtime' => self::getRuntimeFields(),
			'order' => $order,
