...
use Bitrix\Iblock\Elements\ElementcharacteristicsFileBindingsTable;
 ...
 *
 */
class CharacteristicsToPhoto implements Model,Arrayable,Jsonable
{
	...
	public function setAttributes(array $newValues): CharacteristicsToPhoto
	{
	...
	public static function findOne(array $filter = []): ?CharacteristicsToPhoto
	{
		/** @noinspection PhpUnhandledExceptionInspection */
		$userFields = ElementcharacteristicsFileBindingsTable::getRow([
			'filter' => $filter,
	...
	{
		/** @noinspection PhpUnhandledExceptionInspection */
		$users = collect(ElementcharacteristicsFileBindingsTable::getList([
			'filter' => $filter,
			'select' => array_merge(array_keys(self::getAttributesMap()),self::getPropertyMap()),
			'runtime' => self::getRuntimeFields(),
			'order' => $order,
